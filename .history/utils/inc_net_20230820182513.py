...
class IncrementalNet(BaseNet):
    ...
    def update_fc(self, nb_classes):
        fc = self.generate_fc(self.from timm.models.registry import register_model
from timm.scheduler import create_scheduler
from timm.optim import create_optimizer, nb_classes)
